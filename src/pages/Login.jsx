        ...
        <div className="relative z-10 p-12 flex flex-col h-full justify-between w-full max-w-2xl mx-auto">
          ...
          <div className="mb-20">
            <h2 className="text-5xl font-bold text-white mb-6 leading-tight">
              ...
              <span className="text-blue-200">sur le terrain.</span>
            </h2>
            <p className="text-lg text-blue-100 max-w-md leading-relaxed">
              Une plateforme moderne pour le suivi des aides, la gestion des inventaires, et la coordination des équipes en temps réel.
            </p>
          </div>
          
          <div className="flex items-center gap-4 text-blue-100 text-sm font-medium">
            <span className="px-3 py-1 rounded-full border border-blue-400/30 bg-blue-800/30 backdrop-blur-sm">Sécurisé</span>
            <span className="px-3 py-1 rounded-full border border-blue-400/30 bg-blue-800/30 backdrop-blur-sm">Temps Réel</span>
            <span className="px-3 py-1 rounded-full border border-blue-400/30 bg-blue-800/30 backdrop-blur-sm">Multi-plateforme</span>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 relative">
        ...
        <div className="w-full max-w-md">
          <div className="mb-10 text-center lg:text-left">
            ...
            <h2 className="text-3xl font-bold text-slate-800 dark:text-slate-100 mb-2">Bienvenue</h2>
            <p className="text-slate-600 dark:text-slate-400">Connectez-vous pour accéder au système.</p>
          </div>
          ...
          <div className="mt-10 pt-6 border-t border-slate-200 dark:border-slate-800 text-center">
            <p className="text-sm text-slate-500 dark:text-slate-400">
              Besoin d'aide ? <a href="#" className="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400">Contacter le support</a>
            </p>
          </div>
        </div>
      </div>
